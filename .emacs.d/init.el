...
(custom-set-variables
 ...
 '(org-agenda-files (quote ("~/Dropbox/org/tasks.org" "~/Documents/tasks.org")))
 '(package-selected-packages
   (quote
    (ipython ob-ipython csv-mode smartparens evil-easymotion doom expand-region yasnippet-classic-snippets yasnippet-snippets mu4e-maildirs-extension exec-path-from-shell evil-search-highlight-persist flymd linum-relative doom-modeline helm-spotify-plus dockerfile-mode org-pomodoro ag projectile material-theme monokai-theme leuven-theme org-bullets helm-ag dumb-jump zenburn-theme doom-themes evil-magit powerline-evil smart-mode-line evil yaml-mode writegood-mode web-mode undo-tree solarized-theme powerline markdown-mode magit goto-last-change flycheck autopair auto-complete))))
(custom-set-faces
...
(global-set-key (kbd "C-S-e") 'sp-end-of-sexp)
